...
c_yes = ("yup","done", "yes", "yeah", "sure", "ok", "okay", "roger", "you bet", "right", "definitely", "of course", "totally", "i agree", "absolutely", "sure thing", "no problem", "cool", "for sure", "you got it", "no doubt", "all right", "certainly", "affirmative", "indeed", "absolutely", "i concur", "most assuredly", "without a doubt", "that is correct")
