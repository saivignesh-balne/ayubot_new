...
def ayurbot():
    ...
    st.markdown(
        """
        <h5 style="color: #D3D3D3,font-weight: 100;">Hi there! I am Chatbot specific to determine the Prakriti of an individual. So now lets determine your Prakriti!</h5>
        """,
        unsafe_allow_html=True
    )
